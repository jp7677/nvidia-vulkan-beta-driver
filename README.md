...
VERSION=595.44.03 ./make-rpms.sh
```

Installing by running (dry-run), you might need to adjust epoch versions:

```bash
VERSION=595.44.03;dnf install --allowerasing --assumeno \
  rpmbuild/RPMS/noarch/nvidia-kmod-common-$VERSION-2.fc43.noarch.rpm \
  rpmbuild/RPMS/noarch/dkms-nvidia-$VERSION-1.fc43.noarch.rpm \
  rpmbuild/RPMS/x86_64/nvidia-driver-$VERSION-3.fc43.x86_64.rpm \
  rpmbuild/RPMS/x86_64/nvidia-driver-libs-$VERSION-3.fc43.x86_64.rpm \
  rpmbuild/RPMS/x86_64/nvidia-driver-cuda-libs-$VERSION-3.fc43.x86_64.rpm \
  rpmbuild/RPMS/x86_64/libnvidia-cfg-$VERSION-3.fc43.x86_64.rpm \
  rpmbuild/RPMS/x86_64/libnvidia-gpucomp-$VERSION-3.fc43.x86_64.rpm \
  rpmbuild/RPMS/x86_64/libnvidia-ml-$VERSION-3.fc43.x86_64.rpm \
  rpmbuild/RPMS/i686/nvidia-driver-libs-$VERSION-3.fc43.i686.rpm \
  rpmbuild/RPMS/i686/nvidia-driver-cuda-libs-$VERSION-3.fc43.i686.rpm \
  rpmbuild/RPMS/i686/libnvidia-gpucomp-$VERSION-3.fc43.i686.rpm \
  rpmbuild/RPMS/i686/libnvidia-ml-$VERSION-3.fc43.i686.rpm
```
...
```bash
VERSION=595.44.03;dnf remove --noautoremove --assumeno \
