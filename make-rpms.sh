...
rpmbuild \
    --define "_topdir $PWD/rpmbuild" \
    --define "_sourcedir $PWD/nvidia-kmod-common" \
    --define "_specdir $PWD/nvidia-kmod-common" \
    --target x86_64 \
    --clean \
    -bb nvidia-kmod-common/nvidia-kmod-common.spec
rpmbuild \
    --define "_topdir $PWD/rpmbuild" \
    --define "_sourcedir $PWD/nvidia-kmod" \
    --define "_specdir $PWD/nvidia-kmod" \
    --target x86_64 \
    --clean \
    -bb nvidia-kmod/nvidia-kmod.spec
rpmbuild \
    --define "_topdir $PWD/rpmbuild" \
    --define "_sourcedir $PWD/dkms-nvidia" \
    --define "_specdir $PWD/dkms-nvidia" \
    --target x86_64 \
    --clean \
    -bb dkms-nvidia/dkms-nvidia.spec
